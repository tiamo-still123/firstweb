...
<div id="form_register">
    ...
    <form action="/project2_war/registerServlet" id="form_id" method="post">
        ...
        <div class="Spassword">
            <input type="password" name="password2" id="Spassword" required placeholder="确认密码" />
        </div>
...
<div id="form_login" class="loginform">
    ...
    <form id="form_id" action="/project2_war/loginServlet" method="post">
        <div class="email">
            <input class="inputBox" required type="num" placeholder="账号" id="username" name="username" />
        </div>
        <div class="password">
            <input class="inputBox" required type="password" id="password" name="password" placeholder="密码" />
        </div>
        <div class="remember">
            <input class="checkbox" type="checkbox" id="remember" />
            <label for="remember">记住密码</label>
            <input class="checkbox" type="checkbox" id="autoLogin" />
